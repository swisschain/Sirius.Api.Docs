...
| `Order`        | *optional*, *[PaginationOrder](#api-usage-pagination-request)*, enum  | *REST* Descending or ascending sort of entries       |                                            |
| `Limit`        | *optional*, *[PaginationLimit](#api-usage-pagination-request)*, int   | *REST* Maximum number of entries to fetch            |                                            |
| `Cursor`       | *optional*, *[PaginationCursor](#api-usage-pagination-request)*, long | *REST* ID of anchor entity to start pagination from  |                                            |
...
| `Chainalysis`   | *[AmlChainalysisAssetAttributesInfo](#assets-models-amlchainalysisassetattributesinfo)*     | Chainalysis attributes   |         |
| `MerkleScience` | *[AmlMerkleScienceAssetAttributesInfo](#amlmerklescienceassetattributesinfo)* | MerkleScience attributes |         |
